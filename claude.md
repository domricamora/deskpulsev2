...
Before modifying functionality, Claude Code must audit the existing application.
...
Read CLAUDE.md, README.md, server/schema.sql, every PHP source file under server/src, every relevant template, the Python agent implementation, and tools/test_webhook.py.
