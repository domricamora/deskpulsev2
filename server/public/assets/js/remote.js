/* Remote desktop control console (super-admin only, unpublished).
 ...
 * app base path is honored. CSRF is sent as a form field (_csrf); the input batch
 * travels as a JSON string in `payload` so the server's check_csrf() (which reads
 * $_POST) works unchanged. */
(function () {
