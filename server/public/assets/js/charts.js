 ...
 * templates already emit. Chart.js itself is vendored locally (assets/js/vendor/chart.umd.js,
 * MIT licensed) — no CDN, no build step.
...
(function () {
  if (typeof Chart === 'undefined') return;   // vendor script failed to load — fail quiet
