...
{{--
    Download the agent. Ported from server/templates/dashboard/download.php.

    The three buttons target /download/app?os=… — the public marketing route,
    which serves a native installer when one has been built and the portable
    package otherwise. That route arrives in Phase 18.
--}}
...
@section('content')
    ...
    <div class="panel">
        ...
        <p>
            <a class="btn lg" href="{{ url('/download/app?os=win') }}">⬇ Download for Windows</a>
            <a class="btn lg" href="{{ url('/download/app?os=mac') }}">⬇ Download for macOS</a>
            <a class="btn lg" href="{{ url('/download/app?os=linux') }}">⬇ Download for Linux</a>
        </p>
    ...
    <div class="two-col">
        <div class="panel">
            ...
            <ol class="steps">
                ...
                <li>Enter this <b>Server URL</b>:<br><code>{{ $serverUrl }}</code></li>
        ...
        <div class="panel">
            ...
            <ul class="plain">
                ...
                @empty
                    <li class="muted">No devices yet — sign in from the desktop app to register one.</li>
                @endforelse
            </ul>
        </div>
    </div>
