...
(function () {
  ...
  // 4b. Period "jump to date" pickers submit on change. This was an inline
  // onchange="this.form.submit()" in the legacy markup; decision D13 rules out
  // style-src/script-src 'unsafe-inline', so the behaviour moves here.
  ...
  // 4c. Destructive forms confirm before submitting. These were inline
  // onsubmit="return confirm(...)" attributes; the prompt text is unchanged.
